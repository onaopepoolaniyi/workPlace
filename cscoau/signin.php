...
<div id="templatemo_menu">
    <ul>
        ...
        <li><a href="signin.php" class="current" onClick="return false"> Academics</a></li>
   ...
   <!-- <div id="templatemo_content_top"></div>  -->
    <div id="templatemo_content">
    	<div id="templatemo_main_content">
        	...
        	<h2>Course List</h2>
    <div id="gallery">
     <a href="#"><h5>Undergraduate courses</h5></a>
     
    
       
        <li><a href="undergraduate.html">Computer Engineering</a></li>
         <li><a href="undergraduate.html">Computer Science with Economics</a></li>
          <li><a href="undergraduate.html">Computer Science with Mathematics</a></li>
                      
                            

        <br />
        
<!--  <a href="postgraduate.html" onclick="return false"><h5> Postgraduate courses</h5></a>-->
    <a href="download.php"><h5> Course materials</h5></a>
		...
		else
		{
			...
			else
			{
				...
				else
				{
					...
					echo 'Welcome, ' . $_SESSION['user_name'] . '. <br /><a href="fileupload.php">Proceed to upload page</a>.<br />
					<a href="signin.php">Go back to login section</a>.<br /> Do not leave the academics section, unless you will lose your account session';
				}
			}
		}
	}
